-- Migration: Contact Dedup & Merge
-- Adiciona detecção de duplicatas e merge atômico de contatos.
...
CREATE INDEX IF NOT EXISTS idx_merge_log_org ON contact_merge_log(organization_id);
...
-- =============================================================================
-- 5. RPC: merge_contacts (SECURITY DEFINER)
-- =============================================================================
